...
def main():
    ...
    st.markdown('''
    # Simple Stock App
    A stock app to research stocks and track performance over time. This tool is used for educational purposes only and does not provide any financial investment advice. Do your own research and due dilligence before buying or selling stocks. Invest at your own risk. This data is updated every hour and may be delayed.
    ''')
